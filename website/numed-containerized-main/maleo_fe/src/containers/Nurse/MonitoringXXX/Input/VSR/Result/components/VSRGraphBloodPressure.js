...
const VSRGraphBloodPressure = ({ dir }) => {
  const { t } = useTranslation('common');

  return (
    <Panel xs={6} lg={6} title={t('Blood Pressure')}>
      <div dir="ltr">
...
VSRGraphBloodPressure.propTypes = {
  dir: PropTypes.string.isRequired,
};

export default connect((state) => ({ themeName: state.theme.className }))(VSRGraphBloodPressure);
