...
const userDetail = (history, info) => {
  history.push({
    pathname: `/patient-data/ctscan/${info.id}`,
    state: { data: info },
  });
};

const ListCTScanTable = ({ listDataTable, isLoading }) => {
  const tableConfig = {
    isEditable: false,
    isSortable: true,
    isResizable: false,
      ...
      <Card>
        <CardBody className="dashboard__booking-card">
          <div className="card__title">
            <h5 className="bold-text">List of CT-Scan Result</h5>
...
export default ListCTScanTable;
