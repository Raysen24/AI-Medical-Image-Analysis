...
const VSRGraphHeartRate = ({ dir }) => {
  const { t } = useTranslation('common');

  return (
    <Panel xs={4} lg={4} title={t('Heart Rate')}>
      <div dir="ltr">
...
VSRGraphHeartRate.propTypes = {
  dir: PropTypes.string.isRequired,
};

export default connect((state) => ({ themeName: state.theme.className }))(VSRGraphHeartRate);
