...
const VSRGraphTemperature = ({ dir }) => {
  const { t } = useTranslation('common');

  return (
    <Panel xs={4} lg={4} title={t('Temperature')}>
      <div dir="ltr">
...
VSRGraphTemperature.propTypes = {
  dir: PropTypes.string.isRequired,
};

export default connect((state) => ({ themeName: state.theme.className }))(VSRGraphTemperature);
