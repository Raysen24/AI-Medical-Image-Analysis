...
const VSRGraphRespiratoryRate = ({ dir }) => {
  const { t } = useTranslation('common');

  return (
    <Panel xs={6} lg={6} title={t('Respiratory Rate')}>
      <div dir="ltr">
...
VSRGraphRespiratoryRate.propTypes = {
  dir: PropTypes.string.isRequired,
};

export default connect((state) => ({ themeName: state.theme.className }))(VSRGraphRespiratoryRate);
