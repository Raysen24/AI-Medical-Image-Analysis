...
const CommunityCard = () => {
  ...
  const onSubmit = (e) => {
    ...
    data.append('room_name', [e.target.room_name][0].value);
    data.append('room_number', [e.target.room_number][0].value);
    data.append('is_active', [e.target.is_active][0].checked);
    data.append('building_id', [e.target.building_id][0].value);
    ...
    axios.post(ROOM_MANAGEMENT, data, options)
      .then(() => {
      ...
      <Card>
        <CardBody className="dashboard__booking-card">
          <div className="card__title">
            <h5 className="bold-text">Room Information</h5>
          </div>
