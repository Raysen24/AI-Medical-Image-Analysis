...
const SuggestionMulti = () => {
  ...
  const createCommentFile = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/MULTICLASS/create-comment-file`, formData, {
  ...
  const createRating = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/MULTICLASS/create-rating`, formData, {
        headers: { 'Content-Type': 'multipart/form-data' },
      });
