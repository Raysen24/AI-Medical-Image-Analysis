      ...
      <Card>
        <CardBody className="dashboard__booking-card">
          <div className="card__title">
            <h5 className="bold-text">{t('patient.input.pcr.page_title')}</h5>
            <ButtonToolbar className="products-list__btn-toolbar-top">
              <Link className="btn btn-primary products-list__btn-add" to="/patient-data/input/upload">{t('ui.btn.new')}
              </Link>
            </ButtonToolbar>
          </div>
          {isLoading ? <Spinner /> : (
