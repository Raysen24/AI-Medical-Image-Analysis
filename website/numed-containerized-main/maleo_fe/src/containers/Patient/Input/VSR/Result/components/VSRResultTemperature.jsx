...
import Ava1 from '../../../../../../shared/img/assets/temperature.png';

const VSRResultTemperature = () => {
        ...
        <CardBody className="dashboard__booking-card">
          <div className="dashboard__booking-total-container">
            <h5 className="dashboard__booking-total-title dashboard__booking-total-title--red">
              {loading && vsr[0] ? vsr[0].temperature.toFixed(1) : ''}
            </h5>
            <div className="dashboard__competitor-img">
              <img src={Ava1} alt="" />
            </div>
          </div>
          <h5 className="dashboard__booking-total-description">Temperature (C)</h5>
        </CardBody>
      </Card>
    </Col>
  );
...
export default VSRResultTemperature;
