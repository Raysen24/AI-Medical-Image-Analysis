...
import Ava1 from '../../../../../../shared/img/assets/heart_rate.png';

const VSRResultHeartRate = () => {
        ...
        <CardBody className="dashboard__booking-card">
          <div className="dashboard__booking-total-container">
            <h5 className="dashboard__booking-total-title dashboard__booking-total-title--red">
              {loading && vsr[0] ? vsr[0].heart_rate.toFixed(1) : ''}
            </h5>
            <div className="dashboard__competitor-img">
              <img src={Ava1} alt="" />
            </div>
          </div>
          <h5 className="dashboard__booking-total-description">Heart Rate (BPM)</h5>
        </CardBody>
      </Card>
    </Col>
  );
...
export default VSRResultHeartRate;
